                ...
                <div className='py-12'>
                    ...
                    <div className='lg:flex gap-x-20'>
                        <div className='w-full lg:w-[40%] xl:w-[30%] space-y-6'>
                            ...
                            {contactArray.map((item, i) =>  (<div key={i} style={{ background: `${local === "dark" ? "#212425" : item?.bg}` }} className='flex flex-wrap    dark:bg-transparent p-[30px]  border-[#A6A6A6] gap-2 rounded-xl '>
