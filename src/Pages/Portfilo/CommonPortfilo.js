  ...
  return (
    <section className="bg-white  lg:rounded-2xl dark:bg-[#111111]">
      <div className="container mb-8   px-4 sm:px-5 md:px-10 lg:px-[60px]">
        <div className="py-12">
          <h2 className="after-effect  after:left-48">Portfolio</h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 my-6">
                <div className="space-y-2">
                  <p className="dark:text-white flex items-center text-[15px]  sm:text-lg ">
                    <FaRegFileAlt className="sm:text-lg hidden sm:block mr-2  md:text-xl" />
                    Project : <span className="font-medium "> Website</span>
                  </p>
                  <p className="dark:text-white flex items-center text-[15px]  sm:text-lg ">
                    <HiCode className="text-lg mr-2 hidden sm:block " />
                    Langages :
                    <span className="font-medium ">{singleData?.langages}</span>
                  </p>
                </div>
                <div className="space-y-2">
                  <p className="dark:text-white flex items-center mt-2 md:mt-0 text-[15px]  sm:text-lg ">
                    <FaUser className="text-lg mr-2 hidden sm:block" />
                    Client :
